...
DATABASES = {
    'default': {
        ...
        'NAME': join_path(PROJECT_ROOT, 'movies.db'),
    }
}
...
STATICFILES_DIRS = (
    ...
    join_path(PROJECT_ROOT, 'statics/LiScroll/').replace('\\', '/'),
    join_path(PROJECT_ROOT, 'statics/images/').replace('\\', '/'),
...
ROOT_URLCONF = 'moviebar.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'moviebar.wsgi.application'
